/**
 * @generated SignedSource<<1f9afd2d58cf03e19b10b077c54ea6de>>
...
export type IngredientIngredientSelectColumn = "foodId" | "id" | "recipeId" | "wikiUrl" | "%future added value";
export type IngredientIngredientUpdateColumn = "foodId" | "id" | "recipeId" | "wikiUrl" | "%future added value";
export type RecipeDirectionConstraint = "direction_pkey" | "%future added value";
...
export type RecipeIngredientConstraint = "ingredient_pkey" | "%future added value";
...
export type RecipeRecipeConstraint = "recipe_pkey" | "%future added value";
export type RecipeRecipeSelectColumn = "createdAt" | "creatorId" | "extractionMetadata" | "hidden" | "id" | "imageUrl" | "name" | "parentId" | "slug" | "sourcePath" | "sourceProviderId" | "updatedAt" | "videoUrl" | "%future added value";
export type RecipeRecipeUpdateColumn = "createdAt" | "creatorId" | "extractionMetadata" | "hidden" | "id" | "imageUrl" | "name" | "parentId" | "slug" | "sourcePath" | "sourceProviderId" | "updatedAt" | "videoUrl" | "%future added value";
export type RecipeSourceProviderConstraint = "source_provider_pkey" | "%future added value";
...
export type recipe_recipe_select_column_recipe_recipe_aggregate_bool_exp_bool_and_arguments_columns = "hidden" | "%future added value";
export type recipe_recipe_select_column_recipe_recipe_aggregate_bool_exp_bool_or_arguments_columns = "hidden" | "%future added value";
export type RecipeRecipeInsertInput = {
  ...
  ingredients?: IngredientIngredientArrRelInsertInput | null;
  name?: string | null;
...
export type RecipeRecipeBoolExp = {
  ...
  hidden?: BooleanComparisonExp | null;
  id?: UuidComparisonExp | null;
  imageUrl?: StringComparisonExp | null;
  ingredients?: IngredientIngredientBoolExp | null;
  ingredients_aggregate?: ingredient_ingredient_aggregate_bool_exp | null;
  name?: StringComparisonExp | null;
...
export type ingredient_ingredient_aggregate_bool_exp = {
  count?: ingredient_ingredient_aggregate_bool_exp_count | null;
};
export type ingredient_ingredient_aggregate_bool_exp_count = {
  arguments?: ReadonlyArray<IngredientIngredientSelectColumn> | null;
  distinct?: boolean | null;
  filter?: IngredientIngredientBoolExp | null;
  predicate: IntComparisonExp;
};
...
export type recipe_recipe_aggregate_bool_exp = {
  bool_and?: recipe_recipe_aggregate_bool_exp_bool_and | null;
  bool_or?: recipe_recipe_aggregate_bool_exp_bool_or | null;
  count?: recipe_recipe_aggregate_bool_exp_count | null;
};
export type recipe_recipe_aggregate_bool_exp_bool_and = {
...
export type recipe_recipe_aggregate_bool_exp_bool_or = {
...
export type IngredientIngredientArrRelInsertInput = {
  data: ReadonlyArray<IngredientIngredientInsertInput>;
  onConflict?: IngredientIngredientOnConflict | null;
};
...
return {
  ...
  "params": {
    "cacheID": "349937785711a122ac4f7ed3d94e6268",
    "id": null,
    "metadata": {},
    "name": "RecipeFormMutation",
...
(node as any).hash = "b166d2c75c718dc610b63e58e3806078";
