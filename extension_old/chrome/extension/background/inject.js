...
function loadScript(name, tabId, cb) {
  if (process.env.NODE_ENV === 'production') {
    ...
    .then((fetchRes) => {
      ...
      request.open('GET', 'chrome-extension://dcdggppoppjpjelaodaemfcannmljdbk/js/redux-devtools-extension.js');  // sync
      request.send();
      request.onload = () => {
...
const arrowURLs = ['^https://www\\.americastestkitchen\\.com'];
